...
namespace challenge.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        {
            _employeeRepository.LoadReports(employee);
        ...
        public void CreateOrReplaceCompensation(Compensation compensation)
        {
            var original = _employeeRepository.GetCompensation(compensation.Employee);
            if (original != null)
            {
                _employeeRepository.RemoveCompensation(original);
                _employeeRepository.SaveAsync().Wait();
            }
